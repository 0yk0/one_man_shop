      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex flex-wrap justify-center gap-2 mb-8">
            {tabs.map((tab, i) => (
              <button key={tab.id} onClick={() => setActiveTab(i)} className={`px-4 sm:px-5 py-2 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium transition-all duration-200 ${
                activeTab === i 
          ...
          <div className="max-w-4xl mx-auto">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-dark-card"
              >
                <img 
