...
public class WailsBridge {
    ...
    /** Absolute path to the app's external files directory
     *  (getExternalFilesDir()), which survives uninstall on Android 11+.
     *  Suitable for user data that should persist across app reinstalls. */
